...
Näkymä hoitaa kaiken graafisen mikä näytetään selaimessa. Sen tulee myös pystyä kommunikoimaan suoraan ohjaimelle sekä siihen rekisteröidylle mallille. Ohjain puolestaan ottaa vastaan syötteitä ja lähettää viestejä tämän perusteella näkymälle ja mallille. Näiden rajoituksien perusteella pystytään vastaamaan tutkimuksessa siihen, toteuttaako Pyramid MVC-arkkitehtuurin vai ei.
...
Tutkielma keskittyy tarkastelemaan ohjaimen toteutusta. Koska ohjainta ei ole konkreettisesti määritelty, selvitetään millä tavalla se toteutetaan Pyramidissa. Samalla tutkitaan voidaanko Pyramid tämän perusteella luokitella MVC:n toteuttavaksi sovelluskehykseksi. Erityisesti tarkastelun kohteena on \emph{views.py} -tiedostossa toteutettu
näkymän ohjelmakoodi, joka voidaan mahdollisesti tulkita ohjaimeksi. Template on tällöin mahdollista luokitella näkymäksi, josse toteuttaa näkymälle määrätyt ominaisuudet.
